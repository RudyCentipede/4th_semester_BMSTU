...
{
    if (edge.first_point_index < 0 || edge.first_point_index >= points_size|| edge.second_point_index < 0 || edge.second_point_index >= points_size)
        return ERROR_WRONG_POINT_INDEX;
