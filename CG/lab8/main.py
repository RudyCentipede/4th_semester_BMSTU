...
lineColourBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text='Выбрать другой цвет от-ка', font=("Consolas", 13), command=get_colour_line)
...
drawClipperVertexBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text="Построить вершину", font=("Consolas", 13), command=drawVertex)
drawClipperCloseBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text="Замкнуть", font=("Consolas", 13), command=click_middle)
...
labelTextInfo_2 = tk.Label(dataFrame, bg=MAIN_FRAME_COLOR, text="Средная кнопка - Замкнуть отсекатель",
                             font=("Consolas", 12),
                             fg=MAIN_COLOUR_LABEL_TEXT)
labelTextInfo_3 = tk.Label(dataFrame, bg=MAIN_FRAME_COLOR, text="Правая кнопка - Добавить вершину отрезка",
                             font=("Consolas", 12),
                             fg=MAIN_COLOUR_LABEL_TEXT)
...
cutBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text="Отсечь", font=("Consolas", 13), command=cut_off_command)
ParalelLinesBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text="Построить параллельные отрезки", font=("Consolas", 13), command=addParallelLines)
clearCanvasBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text="Очистить экран", font=("Consolas", 13), command=clear_canvas)
