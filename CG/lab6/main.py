...
borderColourBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text='Выбрать цвет границы', font=("Consolas", 12), command=lambda: get_colour("border"))
fillColourBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text='Выбрать цвет закраски', font=("Consolas", 12), command=lambda: get_colour("fill"))
...
borderColourBtn.place(x=1.5 * DATA_FRAME_WIGHT // 3 - BORDERS_SPACE, y=yColourLine * DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT // 2 + 3, height=DATA_FRAME_HEIGHT // COLUMNS)
fillColourBtn.place(x=1.5 * DATA_FRAME_WIGHT // 3 - BORDERS_SPACE, y=(yColourLine + 1.1) * DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT // 2 + 3, height=DATA_FRAME_HEIGHT // COLUMNS)
...
borderCurColourLabel.place(x=DATA_FRAME_WIGHT // 3 + BORDERS_SPACE + 5, y=yColourLine * DATA_FRAME_HEIGHT // COLUMNS + 5, width=DATA_FRAME_WIGHT // 9 - 5, height=DATA_FRAME_HEIGHT // COLUMNS - 10)
fillCurColourLabel.place(x=DATA_FRAME_WIGHT // 3 + BORDERS_SPACE + 5, y=(yColourLine + 1.1) * DATA_FRAME_HEIGHT // COLUMNS + 5, width=DATA_FRAME_WIGHT // 9 - 5, height=DATA_FRAME_HEIGHT // COLUMNS - 10)
...
tk.Radiobutton(dataFrame, variable=methodDraw, text="С задержкой", value=0, bg=MAIN_FRAME_COLOR,
                font=("Consolas", 16), justify=tk.LEFT, fg=MAIN_COLOUR_LABEL_TEXT, selectcolor="grey",
...
drawSeedBtn.place(x=DATA_FRAME_WIGHT // 3.5 - 20, y=(makePoint + 4) * DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT // 2 + 10, height=DATA_FRAME_HEIGHT // COLUMNS)
# ------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
labelTextInfo_4 = tk.Label(dataFrame, bg=MAIN_FRAME_COLOR, text="Зажать левую кнопку - рисование кривых",
                             font=("Consolas", 12),
                             fg=MAIN_COLOUR_LABEL_TEXT)
...
# --------------------------------------------------------------------------------------------------
lineMakeLabel = tk.Label(dataFrame, bg=MAIN_COLOUR_LABEL_BG, text="Построение окружности и эллипса",
                             font=("Consolas", 15),
                             fg=MAIN_COLOUR_LABEL_TEXT, relief=tk.SOLID)
...
radiusCircleLabel = tk.Label(dataFrame, bg=MAIN_FRAME_COLOR, text="Радиус:",
                     font=("Consolas", 13),  justify="center",
                     fg=MAIN_COLOUR_LABEL_TEXT)
widthEllipseLabel = tk.Label(dataFrame, bg=MAIN_FRAME_COLOR, text="Высота:",
                     font=("Consolas", 13),  justify="center",
                     fg=MAIN_COLOUR_LABEL_TEXT)

heightEllipseLabel = tk.Label(dataFrame, bg=MAIN_FRAME_COLOR, text="Ширина:",
                     font=("Consolas", 13),  justify="center",
                     fg=MAIN_COLOUR_LABEL_TEXT)
...
drawCircleBtn = tk.Button(dataFrame, bg=MAIN_COLOUR, fg=MAIN_COLOUR_LABEL_TEXT, text="Построить окружность", font=("Consolas", 12),
                          command=add_circle)
...
xcEntry.place(x=DATA_FRAME_WIGHT // 4 + 60, y=(makeCircleOREllipse + 2) * DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT // 4, height=DATA_FRAME_HEIGHT // COLUMNS)
ycEntry.place(x=2 * DATA_FRAME_WIGHT // 4 + 60, y=(makeCircleOREllipse + 2) * DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT // 4, height=DATA_FRAME_HEIGHT // COLUMNS)
...
drawCircleBtn.place(x=10, y=(makeCircleOREllipse + 6) * DATA_FRAME_HEIGHT // COLUMNS, width=DATA_FRAME_WIGHT // 2 - 5, height=DATA_FRAME_HEIGHT // COLUMNS)
